...
import com.hust.bookflow.adapter.helper.OnDragVHListener;
import com.hust.bookflow.adapter.helper.OnItemMoveListener;
...
public class LabelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    // 我的标签 标题
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_MY_CHANNEL_HEADER:
                view = mInflater.inflate(R.layout.item_my_label_header, parent, false);
            ...
            case TYPE_MY:
                view = mInflater.inflate(R.layout.item_mylabel, parent, false);
            ...
            case TYPE_OTHER_CHANNEL_HEADER:
                view = mInflater.inflate(R.layout.item_other_label_header, parent, false);
                return new RecyclerView.ViewHolder(view) {
                };

            case TYPE_OTHER:
                view = mInflater.inflate(R.layout.item_otherlabel, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            myHolder.textView.setText(mMyLabel.get(position - COUNT_PRE_MY_HEADER));
            if (isEditMode) {
            ...
            ((OtherViewHolder) holder).textView.setText(mOtherLabel.get(position - mMyLabel.size() - COUNT_PRE_OTHER_HEADER));
