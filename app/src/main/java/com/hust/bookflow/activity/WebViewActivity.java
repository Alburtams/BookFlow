...
import static com.hust.bookflow.R.id.atv_web_container;
...
public class WebViewActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private ProgressBar atvwebpb;
    private ImageView webviewbtnclose;
    private ImageView webviewbtngo;
    private ImageView webviewbtnrefresh;
    private ImageView webviewbtnto;
