...
import com.hust.bookflow.adapter.ActorAdapter;
...
import com.hust.bookflow.utils.jsoupUtils.GetLikeMovie;
...
public class MovieDetailsActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener, View.OnClickListener {
    ...
    private CardView book_borrow_btn;
...
//        activity_md_ratingnumber = (TextView) activity_md_include.findViewById(R.id.activity_md_ratingnumber);
        ...
        book_borrow_btn = (CardView) findViewById(R.id.activity_md_borrow_btn);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.activity_md_borrow_btn:
                Toast.makeText(this, "借阅成功", Toast.LENGTH_LONG).show();
                break;
        }
    }
