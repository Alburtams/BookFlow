...
import com.hust.bookflow.adapter.ActorMovieAdapter;
import com.hust.bookflow.adapter.base.BaseRecyclerAdapter;
import com.hust.bookflow.model.bean.ActorDetailsBean;
...
import com.hust.bookflow.utils.jsoupUtils.GetActor;
...
public class ActorDetailsActivity extends AppCompatActivity {
    ...
    private CollapsingToolbarLayout actactorcoll;
    private AppBarLayout atvactorappbar;
    ...
    private RecyclerView atvactorrv;
    private LinearLayout atvactorll;
    private android.support.v4.widget.NestedScrollView atvactornest;
    private FloatingActionButton atvactorfab;
    private CoordinatorLayout atvactorcoor;
